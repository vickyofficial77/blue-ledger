      ...
      <div className="max-w-3xl mx-auto bg-white p-20 shadow-[20px_20px_0px_#f1f5f9] border border-slate-200 border-t-8 border-slate-900">
        ...
        <div className="space-y-12 text-slate-600 text-sm leading-relaxed">
           <section>
              ...
              <p>The Operator is granted a non-exclusive license to use the Warenova Sync Core for the duration of the subscription period. Reverse engineering of the sync protocol is strictly forbidden.</p>
           </section>

           <section>
              <h3 className="text-slate-900 font-black uppercase text-xs mb-4 tracking-widest">2. Uptime Service Levels (SLA)</h3>
              <p>Warenova targets 99.9% uptime for the master registry. Planned maintenance windows are typically scheduled during "Cold Hours" (03:00 - 05:00 UTC) and will be broadcast via the Admin Terminal 48 hours prior.</p>
           </section>
           ...
           <section>
              ...
              <p>Warenova is a synchronization tool. While we maintain 99.9% reliability, we are not responsible for inventory losses occurring due to operator error, terminal power failure, or local network instability.</p>
           </section>

           <section className="pt-12 border-t border-slate-100">
              <p className="text-[10px] font-bold text-slate-400 italic">By logging into the Warenova Terminal, you agree to these operational protocols.</p>
           </section>
        </div>
      </div>
    </div>
